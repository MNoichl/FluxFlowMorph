...
The final full-suite command `pytest -q` completed with **184 passed and 7
skipped in 1.70 seconds**. The seven skipped tests are the explicitly opt-in
...
The only reportable timing is the final local full suite: 184 passed and 7
opt-in integration tests skipped in 1.70 seconds. `compileall` passed for
...
passed. The final full suite had no test failures: 184 passed and 7 gated
integration tests skipped in 1.70 seconds. With the declared `ruff==0.14.14`
